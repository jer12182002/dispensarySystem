...
app.post('/saveorder', (req,res) => {
	...
	if(orderInfo.orderId) {
		...
		connection.beginTransaction(err => {
			...
			sqlQueries += `INSERT INTO order_info (ACCOUNT, DATE, CUSTOMER, ADDRESS, PHONE, EMAIL, STATUS,TOTAL_GRAM, DOSAGE_PER_DAY, DAY_PER_SESSION, DISCOUNT_PRICE, DISCOUNT_PERCENTAGE, BOTTLE_FEE, TABLET_FEE, DELIVERY_FEE, TAX, NOTE) VALUES ('${orderInfo.account}', '${orderInfo.date}', '${orderInfo.customer}', '${orderInfo.address}', '${orderInfo.phone}', '${orderInfo.email}', '${orderInfo.status}', '${orderInfo.totalGram}', '${orderInfo.dosagePerDay}', '${orderInfo.dayPerSession}', '${orderInfo.discountPrice}', '${orderInfo.discountPercentage}', '${orderInfo.bottleFee}', '${orderInfo.tabletFee}', '${orderInfo.deliveryFee}', '${orderInfo.tax}', '${orderInfo.orderNote}');`;
