...
export const SAVE_ITEM_CHANGE = (target, item_id) => {
	...
	console.log(item_cellsContainer[2]);
	console.log(item_cellsContainer[1].querySelectorAll("input[type='text']")[0]);
	...
	if(item_englishName + item_chineseName) {
		...
		let editedItem = {
			...
			QTY : item_cellsContainer[2].querySelectorAll("input")[0].value ? item_cellsContainer[2].querySelectorAll("input")[0].value : 0,
			RENDE_PRICE : item_cellsContainer[2].querySelectorAll("input")[1].value ? item_cellsContainer[2].querySelectorAll("input")[1].value : 0,
			STUDENT_PRICE : item_cellsContainer[2].querySelectorAll("input")[2].value ? item_cellsContainer[2].querySelectorAll("input")[2].value : 0, 
			PROFESSOR_PRICE : item_cellsContainer[2].querySelectorAll("input")[3].value ? item_cellsContainer[2].querySelectorAll("input")[3].value : 0
		}
